...
import { aboutFeaturesSection, aboutHeroSection } from "./content";
        ...
        <div className="container">
          <div className="grid items-center gap-8 lg:grid-cols-2">
            <div className="flex flex-col items-center py-32 text-center lg:mx-auto lg:items-start lg:px-0 lg:text-left">
              ...
              {/* <p>{aboutHeroSection.newVersion}</p> */}
              ...
              <div className="flex w-full flex-col justify-center gap-2 sm:flex-row lg:justify-start">
                <Button className="w-full sm:w-auto">
                  <Link href="#features">{aboutHeroSection.cta}</Link>
                </Button>
              </div>
            </div>
